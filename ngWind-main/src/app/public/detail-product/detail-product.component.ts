...
// Enregistrez tous les éléments nécessaires pour Chart.js
...
export class DetailProductComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params.subscribe(params => {
      this.produitId = +params['productId'];
      this.userRole = this.currentUser.user.role;

      if (isNaN(this.produitId)) {
        console.error('Identifiant du produit invalide.');
        return;
      }
